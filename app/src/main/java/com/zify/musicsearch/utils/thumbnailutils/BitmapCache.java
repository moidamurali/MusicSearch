...
public class BitmapCache {
    ...
    private BitmapCache()
    {
        ...
        mDiskLruCache = null;
        File cacheDir = getDiskCacheDir(MusicSearchApplication.getAppContext(), DISK_CACHE_SUBDIR);
                ...
                try {
                    ...
                    if (snapshot == null) {
                        ...
                        if (editor != null) {
                            ...
                            value.compress(
                                    Bitmap.CompressFormat.JPEG, DEFAULT_COMPRESS_QUALITY, out);
                            editor.commit();
                            out.close();
                        }
                    } else {
...
//                        }
    ...
    {
        Bitmap returnBitmap = mLruCache.get(key);
        return returnBitmap;
    }
